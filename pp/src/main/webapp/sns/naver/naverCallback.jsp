...
uv.setUser_name((String)resJson.get("user_name"));
uv.setUser_email((String)resJson.get("user_email"));
uv.setUser_id((String)resJson.get("user_id"));


// 세션 저장
session.setAttribute("authUser", uv);
%>
이름 : <%=(String)resJson.get("user_name")%><br/>
이메일 : <%=(String)resJson.get("user_email")%><br/>
ID : <%=(String)resJson.get("user_id")%><br/>
성별 : <%=(String)resJson.get("user_gender")%><br/>
생일 : <%=(String)resJson.get("user_birthday")%><br/>
<script>
